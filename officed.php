...
<?php 
	if (isset($_GET['edit'])) {
		$office_id = $_GET['edit'];
		$update = true;
		$record = mysqli_query($db, "SELECT * FROM office WHERE office_id='$office_id'");
        ...
        <div class="row">
          <div class="col-md-12">
			...
			<div class="body">
						...
						<?php $results = mysqli_query($db, "SELECT * FROM office"); ?>

							<form id="form_advanced_validation" method="post" action="officed2.php" >		
