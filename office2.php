...
?>
      ...
      <div class="content-wrapper">
        <div class="page-title">
          ...
          <div><a href="office_add.html" class="btn btn-primary btn-flat"><i class="fa fa-lg fa-plus"></i></a><a href="updt_office.html" class="btn btn-info btn-flat"><i class="fa fa-lg fa-refresh"></i></a><a href="dlt_office.html" class="btn btn-warning btn-flat"><i class="fa fa-lg fa-trash"></i></a></div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="card">
				  ...
				  while($query2_row=mysql_fetch_assoc($query2_run))
										{
											...
											$name = $query2_row['name'];
											$intdate = $query2_row['intdate'];

											echo"<tr><td>". $idno."</td><td> ".$name."</td><td> ".$intdate."</td></tr> ";
