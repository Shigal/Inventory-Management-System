...
?>
        ...
        <div class="page-title">
          <div>
            ...
            <ul class="breadcrumb side">
              ...
              <li>Inventory</li>
              <li class="active"><a href="#">Furniture</a></li>
            </ul>
          </div>
          <div><a href="fur_add.html" class="btn btn-primary btn-flat"><i class="fa fa-lg fa-plus"></i></a><a href="updt_furniture.html" class="btn btn-info btn-flat"><i class="fa fa-lg fa-refresh"></i></a><a href="dlt_furniture.html" class="btn btn-warning btn-flat"><i class="fa fa-lg fa-trash"></i></a></div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="card">
	...
	$query4 = "SELECT * FROM furt WHERE foliono='$foliono'";
               ...
               echo" <table id=\"sampleTable\" class=\"table table-hover table-bordered\">
                  <thead>
					...
					while($query4_row=mysql_fetch_assoc($query4_run))
										{
											$idno = $query4_row['idno'];
											
											$type = $query4_row['type'];
											$intdate = $query4_row['intdate'];
											$mat = $query4_row['mat'];
											$dimen = $query4_row['dimen'];
											
											echo"<tr><td>".$idno."</td><td>".$type."</td><td>".$intdate."</td><td>".$mat."</td><td>".$dimen."</td></tr>";
