...
?>
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1>Details on Consumable Equipment</h1>
            <ul class="breadcrumb side">
              <li><i class="fa fa-home fa-lg"></i></li>
              <li>Inventory</li>
              <li class="active"><a href="#">Consumable Equipment</a></li>
            </ul>
          </div>
          <div><a href="consu_add.html" class="btn btn-primary btn-flat"><i class="fa fa-lg fa-plus"></i></a><a href="updt_consumable.html" class="btn btn-info btn-flat"><i class="fa fa-lg fa-refresh"></i></a><a href="dlt_consum.html" class="btn btn-warning btn-flat"><i class="fa fa-lg fa-trash"></i></a></div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="card">
						...
						while($query2_row=mysql_fetch_assoc($query2_run))
										{
											...
											$brand = $query2_row['brand'];
											$size = $query2_row['size'];
											$noitem = $query2_row['noitem'];
											
											echo "<tr><td>". $idno."</td><td>".$intdate."</td><td>".$type."</td><td>".$brand."</td><td>".$size."</td><td>".$noitem."</td></tr>";
										}
										echo"</table>";
                 }		
					}
