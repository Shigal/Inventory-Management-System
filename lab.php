...
?>
      ...
      <div class="content-wrapper">
        <div class="page-title">
          ...
          <div><a href="labd.php" class="btn btn-primary btn-flat"><i class="fa fa-lg fa-plus"></i></a>
		  </div>
        </div>
        <div class="row">
          <div class="col-md-12">
	...
	$query2 = "SELECT type,foliono,COUNT(idno) FROM lab GROUP BY foliono";
									...
									while($query2_row=mysql_fetch_assoc($query2_run))
										{
											...
											echo "<tr>";
											echo "<td>".$type."</td>";
											echo "<td><form action = \"labd3.php\" method = \"post\"><input type = \"hidden\" name = \"foliono\" value = \" ".$foliono."\" style=\"text-decoration:none\"/><input type=\"submit\" value=\" ".$foliono."\"/></form></td>"; 
//											echo "<td><a href=\"state.php?folio=\"".$foliono."\">".$foliono."</a></td>";
