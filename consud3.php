        ...
        <div class="page-title">
          <div>
            ...
            <ul class="breadcrumb side">
              ...
              <li>Inventory</li>
              <li class="active"><a href="consu.php">Consumble</a></li>
            </ul>
          </div>
             ...
             <form id="form1" runat="server">
			  ...
			  <div class="body">
                            <div class="table-responsive">
									...
									$results = mysqli_query($db, "SELECT * FROM cons WHERE type='$type'"); 
...
<table class='table table-bordered table-striped table-hover js-basic-example dataTable'>
	...
	<?php while ($row = mysqli_fetch_array($results)) { ?>
		<tr>
			...
			<td>
				<a href= "consud.php?edit=<?php echo $row['cons_id']; ?>"><i class="fa fa-lg fa-edit"></i></a>
			</td>
			<td>
				<a onClick="javascript: return confirm('Please confirm deletion')" href="consud2.php?del=<?php echo $row['cons_id']; ?>"><i class="fa fa-lg fa-trash"></i></a>
