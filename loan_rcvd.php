          ...
          <div>
           <h1>Details on Loan</h1>
            <ul class="breadcrumb side">
              ...
              <li>Maintenance</li>
              <li class="active"><a href="#">Loan - Received</a></li>
            </ul>
          </div>
          <div><a href="loanRCV_add.html" class="btn btn-primary btn-flat"><i class="fa fa-lg fa-plus"></i></a><a href="updt_loanRCV.html" class="btn btn-info btn-flat"><i class="fa fa-lg fa-refresh"></i></a><a href="dlt_loanRCV.html" class="btn btn-warning btn-flat"><i class="fa fa-lg fa-trash"></i></a></div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="card">
						...
						while($query2_row=mysql_fetch_assoc($query2_run))
										{
											...
											echo "<tr><td>".$rcvdate."</td><td>".$idno."</td><td>".$type."</td><td>".$givendept."</td><td>".$remark."</td></tr>";
