...
?>
      ...
      <div class="content-wrapper">
        <div class="page-title">
          ...
          <div><a href="consu_add.html" class="btn btn-primary btn-flat"><i class="fa fa-lg fa-plus"></i></a></div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="card">
	...
	$query2 = "SELECT type,SUM(noitem) FROM cons GROUP BY type";
					...
					while($query2_row=mysql_fetch_assoc($query2_run))
						{
							...
							$quantity = $query2_row['SUM(noitem)'];
   
							echo "<tr>";
						
							echo "<td><form action = \"consud3.php\" method = \"post\"><input type = \"hidden\" name = \"type\" value = \" ".$type."\" style=\"text-decoration:none\"/><input type=\"submit\" value=\" ".$type."\" style=\"width:100%;border:none\"/></form></td>"; 
