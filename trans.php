...
?>
      ...
      <div class="content-wrapper">
        <div class="page-title">
          ...
          <div><a href="trans_add.html" class="btn btn-primary btn-flat"><i class="fa fa-lg fa-plus"></i></a><a href="updt_transfer.html" class="btn btn-info btn-flat"><i class="fa fa-lg fa-refresh"></i></a><a href="dlt_transfer.html" class="btn btn-warning btn-flat"><i class="fa fa-lg fa-trash"></i></a></div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="card">
				...
				while($query2_row=mysql_fetch_assoc($query2_run))
										{
											...
											echo"<tr><td>" .$trsdate."</td><td> ".$idno."</td><td> ".$type."</td><td> ".$rcvdept."</td></tr> ";
