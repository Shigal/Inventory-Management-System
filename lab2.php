									...
									while($query2_row=mysql_fetch_assoc($query2_run))
										{
											...
											$state = $query2_row['state'];
											$discpt = $query2_row['discpt'];


											echo "<tr><td>".$idno."</td><td>".$serial."</td><td>".$intdate."</td><td>".$warrenty."</td><td>".$type."</td><td>".$make."</td><td>".$model."</td><td>".$yrmanu."</td><td>".$state."</td><td>".$discpt."</td></tr>";
										}
										echo"</table>";
								}
					}
