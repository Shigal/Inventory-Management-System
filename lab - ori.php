...
?>
        ...
        <div class="page-title">
          <div>
            ...
            <ul class="breadcrumb side">
              ...
              <li>Inventory</li>
              <li class="active"><a href="#">Lab Equipment</a></li>
            </ul>
          </div>
          <div><a href="add_lab.html" class="btn btn-primary btn-flat"><i class="fa fa-lg fa-plus"></i></a><a href="updt_lab.html" class="btn btn-info btn-flat"><i class="fa fa-lg fa-refresh"></i></a><a href="dlt_lab.html" class="btn btn-warning btn-flat"><i class="fa fa-lg fa-trash"></i></a></div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="card">
	...
	$query1 = "SELECT * FROM signup WHERE username=123456 AND password=123456" ;
	...
	if($count!= NULL)
		{
									...
									while($query2_row=mysql_fetch_assoc($query2_run))
										{
											...
											$serial = $query2_row['serial'];
											$intdate = $query2_row['intdate'];
											$warrenty = $query2_row['warrenty'];
											$type = $query2_row['type'];
											$make = $query2_row['make'];
											$model = $query2_row['model'];
											$yrmanu = $query2_row['yrmanu'];


											echo "<tr><td>".$idno."</td><td>".$serial."</td><td>".$intdate."</td><td>".$warrenty."</td><td>".$type."</td><td>".$make."</td><td>".$model."</td><td>".$yrmanu."</td></tr>";
										}
										echo"</table>";
								}
					}
			...
			{
			echo "Wrong entry in user name and password";
			}
?>
