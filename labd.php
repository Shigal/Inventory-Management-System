...
<?php 
	if (isset($_GET['edit'])) {
		$lab_id = $_GET['edit'];
		$update = true;
		$record = mysqli_query($db, "SELECT * FROM lab WHERE lab_id='$lab_id'");
...
//                alert("value in js "+inputValue);
                ...
                $.post('labd2.php', { dropdownValue: inputValue }, function(data){
              ...
              <div class="card-body">
				 ...
				 <div class="body">
						...
						<?php $results = mysqli_query($db, "SELECT * FROM lab"); ?>
							...
							<form id="form_advanced_validation" method="post" action="labd2.php" >		
						...
						<input type="hidden" name="lab_id" value="<?php echo $lab_id; ?>">
								...
								<div class="form-group form-float">
									...
									<input type="text" name="foliono" value="<?php echo $foliono; ?>" class="form-control" required>
								</div>
								</div>
								...
								<div class="form-group form-float">
									...
									<input type="text" name="serial" value="<?php echo $serial; ?>" class="form-control" >
								</div>
								</div>
								...
								<div class="form-group form-float">
									...
									<input type="date" name="warrenty" value="<?php echo $warrenty; ?>" class="form-control">
								</div>
								</div>
								...
								<div class="form-group form-float">
									...
									<input type="text" name="yrmanu" value="<?php echo $yrmanu; ?>" class="form-control">
								</div>
								</div>
								...
								<div class="form-group form-float">
									...
									<select name="state" id="myDropDown" value="<?php echo $state; ?>" class="form-control selectpicker">
								...
								<div class="form-group form-float">
									...
									<textarea name="discpt" value="<?php echo $discpt; ?>" class="form-control"></textarea>
								</div>
								</div>
