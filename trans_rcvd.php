...
?>
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1>Details on Transfer</h1>
            <ul class="breadcrumb side">
              <li><i class="fa fa-home fa-lg"></i></li>
              <li>Maintenance</li>
              <li class="active"><a href="#">Transfer - Received</a></li>
            </ul>
          </div>
          <div><a href="transRCV_add.html" class="btn btn-primary btn-flat"><i class="fa fa-lg fa-plus"></i></a><a href="updt_transferRCV.html" class="btn btn-info btn-flat"><i class="fa fa-lg fa-refresh"></i></a><a href="dlt_transferRCV.html" class="btn btn-warning btn-flat"><i class="fa fa-lg fa-trash"></i></a></div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="card">
	...
	echo"<br>";
				...
				while($query2_row=mysql_fetch_assoc($query2_run))
										{
											$trsdate = $query2_row['trsdate'];
											$idno = $query2_row['idno'];
											$type = $query2_row['type'];
											$givendept = $query2_row['givendept'];
											
											echo"<tr><td>" .$trsdate."</td><td> ".$idno."</td><td> ".$type."</td><td> ".$givendept."</td></tr> ";
