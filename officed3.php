        ...
        <div class="page-title">
          <div>
            ...
            <ul class="breadcrumb side">
              ...
              <li>Inventory</li>
              <li class="active"><a href="office.php">Office Equipment</a></li>
            </ul>
          </div>
          <div><a href="officed.html" class="btn btn-primary btn-flat"><i class="fa fa-lg fa-plus"></i></a></div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="card">
			 ...
			 <div class="body">
                            <div class="table-responsive">
									...
									$results = mysqli_query($db, "SELECT * FROM office WHERE foliono='$foliono'"); 
...
<table class='table table-bordered table-striped table-hover js-basic-example dataTable'>
	...
	<?php while ($row = mysqli_fetch_array($results)) { ?>
		<tr>
			...
			<td>
				<a href= "officed.php?edit=<?php echo $row['office_id']; ?>"><i class="fa fa-lg fa-edit"></i></a>
			</td>
			<td>
				<a onClick="javascript: return confirm('Please confirm deletion')" href="officed2.php?del=<?php echo $row['office_id']; ?>"><i class="fa fa-lg fa-trash"></i></a>
