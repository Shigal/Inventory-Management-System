...
<?php 
	if (isset($_GET['edit'])) {
		$furt_id = $_GET['edit'];
		$update = true;
		$record = mysqli_query($db, "SELECT * FROM furt WHERE furt_id='$furt_id'");
            ...
            <div class="card">
              <div class="card-body">
               <div class="body">
						...
						<?php $results = mysqli_query($db, "SELECT * FROM furt"); ?>

							<form id="form_advanced_validation" method="post" action="furd2.php" >		
								
						<input type="hidden" name="furt_id" value="<?php echo $furt_id; ?>">
								...
								<div class="form-group form-float">
									...
									<input type="text" name="dimen" value="<?php echo $dimen; ?>" class="form-control">
								</div>
								</div>
